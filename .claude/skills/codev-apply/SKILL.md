---
name: codev-apply
description: "Implémenter les tâches d'un change codev déjà planifié : lire tasks.md, traiter chaque case non cochée dans l'ordre, cocher au fur et à mesure. Modifie du code du projet. Ne modifie pas d'autres changes, n'archive pas et ne sync pas — ces pas restent explicites côté utilisateur."
allowed-tools: "Bash(codev:*), Read, Write, Edit, Glob, Grep, Bash"
license: MIT
metadata:
  generator: codev
  version: "0.1.0"
